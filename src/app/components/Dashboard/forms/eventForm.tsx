...
export const AddEventForm = ({ isOpen, onClose }: AddEventFormProps) => {
  ...
  } = useEventCategories(); // Modifié en fonction de la structure du hook
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center overflow-y-auto py-8">
      <div className="bg-white rounded-lg p-6 max-w-[1200px] w-full m-4">
        <div className="mb-4">
          ...
          {errorCategories && (
            <p className="text-red-500 mt-2">{errorCategories}</p>
          )}
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Concert Jazz Festival's"
                  required
                />
              </div>
                  ...
                  {imagePreview ? (
                    ...
                    <div className="space-y-2 cursor-pointer">
                      ...
                      <div className="text-sm text-gray-600">
                        Cliquez pour t&eacute;l&eacute;charger une image
                      </div>
                    </div>
                  )}
                </div>
