  ...
  const assistanceCards = [
    {
      ...
      title:
        "Faites vos achats en compagnie de nos Spécialistes. En ligne ou dans un Apple Store.",
      image: MecNoire,
    },
    {
      tag: "TODAY AT APPLE",
    ...
    },
    {
      ...
      subtitle:
        "Laissez-vous guider par nos Spécialistes pour configurer votre appareil et découvrir les dernières fonctionnalités.",
      showIcons: true,
    },
    {
      tag: "GENIUS BAR",
      title:
        "Besoin d'assistance ou de réparations ? Rendez-vous au Genius Bar.",
      atom: true,
      bgColor: "bg-blue-50",
    },
  ];
  ...
  const storeFeatures = [
    {
      ...
      title:
        "Livraison gratuite ou retrait des articles disponibles dans un Apple Store.",
    ...
    },
    {
      ...
      title: [
        "Échangez votre ",
        "appareil",
        ", obtenez un crédit pour un nouveau¹.",
      ],
    ...
    },
    {
      ...
      title: [
        ...
        "Faites graver des emoji, des noms et des chiffres gratuitement.",
      ],
    ...
    },
    {
      ...
      title: [
        "Faites vos achats avec ",
        "l'app Apple Store",
        " et profitez d'une expérience personnalisée.",
      ],
      textColor: "text-blue-500",
    },
    {
      ...
      title: [
        "Personnalisez",
        " votre Mac et créez votre propre style d'Apple Watch.",
      ],
    ...
    <div className="max-w-[1500px] mx-auto px-4 py-8">
      ...
      <div>
        <h2 className="text-3xl font-semibold mb-1">
          ...
          <span className="text-gray-500 font-normal ml-2">
            Toujours plus de raisons d&apos;acheter auprès de nous.
          </span>
        </h2>
          ...
          {storeFeatures.map((feature, index) => (
            ...
            >
              ...
              {Array.isArray(feature.title) ? (
                ...
                <h3 className={`text-sm font-normal ${feature.textColor}`}>
                  {feature.title}
                </h3>
              )}
            </div>
